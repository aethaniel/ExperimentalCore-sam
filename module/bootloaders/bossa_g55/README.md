# Atmel SAM G55 BOSSA Bootloader
...
By pressing this button at reset, the board will stay in bootloader, waiting for communication on either USB or USART.

The USART Communication parameters are a baudrate at 115200, 8bits of data, no parity and 1 stop bit (8N1).
...
PA09 : input (USART0 RX)
PA10 : output (USART0 TX)
